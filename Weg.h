...
public:
	Weg();
	Weg(std::string sName, double dLaenge, Tempolimit eTempolimit = Tempolimit::Autobahn, bool bUeberholverbot = true);
	...
	//didnt check if there is a ueberholverbot before setting the schranke
